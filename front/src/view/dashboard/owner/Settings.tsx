                            ...
                            <div className="st-panel op-anim-in">
                                ...
                                <div className="st-2fa-section">
                                    <div className="st-2fa-header">
                                        ...
                                        <div className="st-2fa-status">
                                            {twoFAEnabled ? (
                                                <span className="st-badge st-badge-success">Enabled</span>
                                            ) : (
                                                <span className="st-badge st-badge-warning">Disabled</span>
                                            )}
                                        </div>
                                    </div>
                                    <div className="st-2fa-actions">
                                        {twoFAEnabled ? (
                                            <button className="op-btn-secondary" onClick={() => alert('Disable 2FA feature coming soon')}>Disable 2FA</button>
                                        ) : (
                                            <button className="op-btn-primary" onClick={() => navigate('/2fa/setup')}>Enable 2FA</button>
                                        )}
                                    </div>
                                </div>
