...
// ── DONNÉES : Propriétés du propriétaire
// TODO: Plus tard, remplacer par un vrai appel API
const PROPERTIES = [
...
// ── COMPOSANT : Boutons d'action en haut de page
const PageAction = () => (
    <>
...
const ProprioDashboard = () => {
    ...
    // Filtre actif sur les listings (all / sale / rent)
    ...
    // Totaux calculés pour les stats
...
{/*KPI*/}
            ...
            {/* ── GRILLE PRINCIPALE ────────────────────────────────
             * Gauche : liste des propriétés
             * Droite : demandes + graphique views
             ─────────────────────────────────────────────────────── */}
            ...
            <InvestmentTimeline
                ...
                monthlyRent={2800}
                propertyName="Villa Anfa — Portefeuille total"
            />
