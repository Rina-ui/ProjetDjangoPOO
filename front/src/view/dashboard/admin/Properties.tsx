...
const getImageUrl = (path: string) => path?.startsWith('http') ? path : `${BASE_URL}${path}`
                            ...
                            <div key={b.id} className="prop-anim"
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                                    <div style={{ width: 46, height: 46, borderRadius: 10, overflow: "hidden", background: "var(--bg2)", flexShrink: 0 }}>
                                        {b.photos_list?.[0]
                                            ? <img src={getImageUrl(b.photos_list[0].image)} style={{ width: "100%", height: "100%", objectFit: "cover" }}/>
                        ...
                        return (
                            <div key={b.id} className="p-card prop-anim" style={{ animationDelay: `${i * 50}ms` }}>
                                <div className="p-card-img">
                                    {b.photos_list?.[0]
                                        ? <img src={getImageUrl(b.photos_list[0].image)} className="p-card-photo" alt=""/>
