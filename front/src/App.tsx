    ...
    <AuthProvider>
        <BrowserRouter>
            <Routes>
                ...
                <Route path="/dashboard/admin/calendar" element={
                ...
                <Route path="/dashboard/owner/properties" element={
                    <ProtectedRoute allowedRoles={["owner"]}><OwnerProperties /></ProtectedRoute>
                }/>
                <Route path="/dashboard/owner/analytics" element={
                    <ProtectedRoute allowedRoles={["owner"]}><OwnerAnalytics /></ProtectedRoute>
                }/>
                <Route path="/dashboard/owner/messages" element={
                    <ProtectedRoute allowedRoles={["owner"]}><OwnerMessages /></ProtectedRoute>
                }/>
                ...
                <Route path="/dashboard/client/saved" element={
                    <ProtectedRoute allowedRoles={["client"]}><ClientSaved /></ProtectedRoute>
                }/>
                <Route path="/dashboard/client/visits" element={
                    <ProtectedRoute allowedRoles={["client"]}><ClientVisits /></ProtectedRoute>
                }/>
