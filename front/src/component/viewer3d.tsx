...
const Viewer3D = ({ prop, onClose }: Props) => {
    ...
    // Toutes les images de la propriété
    const allImgs = [prop.img, ...prop.gallery]

    // Ouvre la galerie pour une pièce donnée
    ...
    useEffect(() => {
        ...
        import("three/addons/loaders/GLTFLoader.js").then(({ GLTFLoader }) => {
            ...
            loader.load(
                ...
                (gltf) => {
                    ...
                    scene.add(model)
                    // Ajuster la caméra selon la taille réelle du modèle
        ...
        // Crée un sprite avec un numéro dessiné sur canvas HTML
                ...
                <div className="c3d-body">
                    ...
                    <div className="c3d-side">
                        ...
                        {activeRoom ? (
                            ...
                            <div className="c3d-room-empty">Clique sur un numéro ou une pièce</div>
                        )}
